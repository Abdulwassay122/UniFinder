...
export default function UniListitems(props) {
  ...
  return (
    <div className={`flex justify-center`}>
      ...
      <div className='border-solid border-b-2 border-x-2 border-black w-[20%] flex px-5 py-3 justify-center items-center'><Link target='_blank' rel="noreferrer" className='flex' href={uniWebsite}>Visit Site <img className='h-4 mx-1 my-2' src={png.src} alt="" /></Link></div>
    </div>
    </div>
  )
}
